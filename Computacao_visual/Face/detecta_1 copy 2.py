...
class FaceDetector:
    ...
    def _detect_faces_in_frame(self, frame) -> Tuple[List[Tuple[int, int, int, int]], List[List[float]]]:
        ...
        # Detecta rostos no frame pequeno
    ...
    def start_detection(self) -> None:
        ...
        try:
            ...
            while True:
                ...
                # Detecta rostos no frame (a cada 3 frames para melhor performance)
                if frame_count % 3 == 0:
                    ...
                    # Reutiliza as detecções anteriores
                    pass
                ...
                self._draw_info_panel(frame, fps, len(face_locations) if frame_count % 3 == 0 else 0)
